                ...
                re: {
                    ...
                    exec: (str)=>{
                        ...
                        const filterLocaleItem = (val)=>{
                            if (i18n) {
                                // locale products can be included in route-matches
                                ...
                                if (typeof _val === 'string' && i18n.locales.some((item)=>{
                                    ...
                                    // remove the locale products from the match
                                    if (isCatchAll) {
                                        val.splice(0, 1);
                                    }
                                    // the value is only a locale products and
                                    // shouldn't be added
...
function normalizeLocalePath(pathname, locales) {
    let detectedLocale;
    // first products will be empty string from splitting at first char
